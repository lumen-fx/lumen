...
//! (widget geometry, caret/text, scrollbar). `lumenc/src/parser_html.rs`
//! keeps a keyword table separate from the stylesheet cascade
//! (`lumen_ir::css::apply_declaration`, unit-tested in `lumen/ir/src/css.rs`
...
//! here has a stylesheet-declaration counterpart in `lumen/ir/src/css.rs`'s
