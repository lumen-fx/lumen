...
budget, a call into a module's [web half](../reference/web-addons.md),
which raises in a render because a web half runs only in a browser. None of them stops a page from being served, and all of them are worth a
line in your log.
