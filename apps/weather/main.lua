...
local function render_hero()
    ...
    if city == "" then
        ...
        set_text("hero-temp", "-")
        set_text("hero-high", "H -")
        set_text("hero-low", "L -")
        return
    end
    local cond = signal("hero_label", "Loading..."):get()
