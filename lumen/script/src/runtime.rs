...
pub struct ScriptPlugin<H: ScriptHost + Resource> {
    host: H,
    source: String,
    uri: String,
}

impl<H: ScriptHost + Resource> ScriptPlugin<H> {
...
impl<H: ScriptHost + Resource> Plugin for ScriptPlugin<H> {
...
pub fn reload_script<H: ScriptHost + Resource>(
    world: &mut World,
    source: &str,
    uri: &str,
...
pub fn tick_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn fire_on_ready<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn sync_signals_into_host<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
/// no-op.
pub fn apply_derivations<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn fire_due_timers<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
    mut timers: ResMut<TimerRegistry>,
    mut out: MessageWriter<ScriptCommandEvent>,
) {
...
pub fn fire_fetched_responses<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
    fetcher: Res<FetchRegistry>,
    mut out: MessageWriter<ScriptCommandEvent>,
) {
...
fn route_event<H: ScriptHost + Resource>(
    host: &mut H,
    event_name: &str,
    fallback_fn: &str,
    id_str: &str,
...
pub(crate) fn route_event_two_args<H: ScriptHost + Resource>(
    host: &mut H,
    event_name: &str,
    fallback_fn: &str,
    key: &str,
...
fn route_event_key_value<H: ScriptHost + Resource>(
    host: &mut H,
    event_name: &str,
    fallback_fn: &str,
    key: &str,
...
fn route_event_id_bool<H: ScriptHost + Resource>(
    host: &mut H,
    event_name: &str,
    fallback_fn: &str,
    id_str: &str,
...
fn route_event_id_f64<H: ScriptHost + Resource>(
    host: &mut H,
    event_name: &str,
    fallback_fn: &str,
    id_str: &str,
...
pub fn dispatch_clicks_and_doubles<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_close_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
/// `on("toggle", "<id>", "<fn>")`.
pub fn dispatch_toggle_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_slider_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_long_press_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_file_drops_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
/// applying first.
pub fn dispatch_hotkeys_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
/// first.
pub fn dispatch_menu_clicks_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_dialog_closes_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_tray_clicks_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
...
pub fn dispatch_file_picks_to_script<H: ScriptHost + Resource>(
    mut host: ResMut<H>,
