...
/// New fields require a corresponding `dirty_mask` bit allocation in `lumen-ffi/src/style_mask.rs`.
///
...
/// Spawn-order tiebreak for focus cycling. `bevy_ecs` 0.18's `Entity: Ord`
