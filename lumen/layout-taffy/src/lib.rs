...
impl Plugin for TaffyLayoutPlugin {
    fn build(self, app: &mut App) {
        app.world.insert_non_send_resource(LayoutResource::new());
        app.world.insert_non_send_resource(CosmicShaper::new());
...
fn lumen_style_to_taffy(s: &Style, dir: LayoutDirection) -> taffy::Style {
    ...
    let justify_content = Some(match s.justify {
        LumenJustify::Start => JustifyContent::FlexStart,
        LumenJustify::End => JustifyContent::FlexEnd,
        LumenJustify::Center => JustifyContent::Center,
        LumenJustify::SpaceBetween => JustifyContent::SpaceBetween,
        LumenJustify::SpaceAround => JustifyContent::SpaceAround,
        LumenJustify::SpaceEvenly => JustifyContent::SpaceEvenly,
    });
    ...
    let align_content = s.align_content.map(|a| {
        ...
        match a {
            ...
            L::Center => T::Center,
            L::Stretch => T::Stretch,
            L::SpaceBetween => T::SpaceBetween,
            L::SpaceAround => T::SpaceAround,
            L::SpaceEvenly => T::SpaceEvenly,
        }
    });
...
fn lumen_align_to_taffy(a: LumenAlign) -> taffy::style::AlignItems {
    ...
    match a {
        LumenAlign::Start => AlignItems::FlexStart,
        LumenAlign::End => AlignItems::FlexEnd,
...
mod tests {
    ...
    fn grid_template_columns_1fr_2fr_splits_one_third_two_thirds() {
        ...
        world.insert_non_send_resource(LayoutResource::new());
        ...
        let layout = world.non_send_resource::<LayoutResource>();
