...
/// shape every shipped skin file uses (`lumen/runtime/src/skins/*.css`).
///
...
mod palette_root_css_tests {
    ...
    //! than by parsing it; `lumenc/tests/palette_theme.rs` and
    //! `lumenc/tests/window_clear_color.rs` exercise it through the real
    //! parser + cascade.
    use super::*;
