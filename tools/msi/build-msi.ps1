...
.EXAMPLE
    tools\msi\build-msi.ps1 -Version 0.1.0 -StageDir msi-stage -OutFile lumen-windows-x86_64.msi
#>
[CmdletBinding()]
param(
...
foreach ($relative in 'bin\lumenc.exe', 'bin\lumen_ffi.dll', 'share\lumen\lumen.receipt') {
