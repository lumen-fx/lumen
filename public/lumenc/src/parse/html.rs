...
pub fn parse_html_with_loader(
    src: &str,
    self_path: &Path,
    loader: &dyn crate::parse::resolve::FileLoader,
...
pub fn parse_markup(
    src: &str,
    self_path: &Path,
    loader: Option<&dyn crate::parse::resolve::FileLoader>,
...
impl FragCtx<'_> {
    ...
    /// The lookup that decides is [`crate::parse::fragments::inline`], which runs
...
fn build_element(
    ...
    let mut attrs = Attributes {
        ...
        // web/src/reset.css, which has to change with these;
        // public/lumenc/tests/web_css.rs is what notices when it does not.
        ...
        // `lumen_runtime::skins::UA` (`core/runtime/src/skins/ua.css`),
...
mod include_tests {
    use super::*;
    use crate::parse::resolve::{FileLoader, normalize_path};
